...
\bigg(\includegraphics[scale=0.3, valign=c]{figs/diagrams/ghostDSE/bare_ghost_propagator.pdf}\bigg)^{-1}\hspace{0.625em} -\hspace{0.625em}   \includegraphics[scale=0.3, valign=c]{figs/diagrams/ghostDSE/ghost_self_energy}
\end{align*}
