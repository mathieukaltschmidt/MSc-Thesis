%general
\title{\LARGE\textsc{Quark Spectral Functions from Dyson-Schwinger Equations\\ with Spectral Renormalization}}
...
\usepackage{physics, slashed} %QFT notation
\usepackage{xfrac, relsize, bbm, chngcntr} %more options for formulas
